...
impl ClientCommand {
    pub fn to_string(&self) -> String {
        match self {
            ...
            ClientCommand::CreateFile { file_id, content } => format!("CREATE_FILE {} {}\n", file_id, content),            
    ...
    pub fn from_string(command: &str) -> Result<ClientCommand, String> {
        ...
        match parts[0] {
            ...
            "CREATE_FILE" => Ok(ClientCommand::CreateFile { file_id: parts[1].to_string(), content: parts[2].to_string() }),            
